...
{
  [Serializable]
  public class KF_ChaosOrganMutation : BaseMutation
  {
    public KF_ChaosOrganMutation() => this.DisplayName = "Chaos Organ";
    ...
    public override string GetDescription() => "Your {{extradimensional|chaos organ}} expands into the space that is not space.\n\nWith time who knows what {{extradimensional|you will become}}.";
